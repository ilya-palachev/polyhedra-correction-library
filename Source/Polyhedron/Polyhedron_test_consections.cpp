...
int Polyhedron::test_inner_consections_facet(bool ifPrint, int fid, double* A,
...
int Polyhedron::test_inner_consections_pair(bool ifPrint, int fid, int id0,
...
int Polyhedron::test_outer_consections_pair(bool ifPrint, int id0, int id1,
		int fid)
{
