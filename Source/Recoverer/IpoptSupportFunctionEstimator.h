 ...
 * function estimation.
 */
class IpoptSupportFunctionEstimator : public TNLP, public SupportFunctionEstimator
{
private:
...
public:
	 ...
	 */
	IpoptSupportFunctionEstimator(SupportFunctionEstimationDataPtr data, const char *linearSolver);
	 ...
	 * @return 		Always true.
	 */
	virtual bool eval_jac_g(Index n, const Number *x, bool new_x, Index m, Index n_ele_jac, Index *iRow, Index *jCol,
							Number *values);
	...
	virtual bool eval_h(Index n, const Number *x, bool new_x, Number obj_factor, Index m, const Number *lambda,
						bool new_lambda, Index n_ele_hess, Index *iRow, Index *jCol, Number *values);
