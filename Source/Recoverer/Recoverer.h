...
public:
	 ...
	 */
	std::pair<VectorXd, SupportFunctionEstimationDataPtr> runEstimation(SupportFunctionDataPtr SData);
	 ...
	 * 				data.
	 */
	Polyhedron_3 buildConsistentBody(VectorXd consistentValues, SupportFunctionEstimationDataPtr SEData);
