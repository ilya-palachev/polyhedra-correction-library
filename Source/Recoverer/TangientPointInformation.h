...
struct TangientPointInformation
{
	 ...
	 */
	TangientPointInformation(int iDirection, Vector_3 direction, Polyhedron_3::Vertex_iterator vertex);
	 ...
	 */
	friend std::ostream &operator<<(std::ostream &stream, TangientPointInformation &info);
