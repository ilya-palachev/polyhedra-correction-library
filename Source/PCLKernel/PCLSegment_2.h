...
public:
	...
	PCLSegment_2(const Point_2 &sp, const Point_2 &tp)
		: sp_(sp), tp_(tp) {}
...
inline
bool
PCLSegment_2<R>::operator==(const PCLSegment_2<R> &s) const
{
...
template < class R >
CGAL_KERNEL_INLINE
const typename PCLSegment_2<R>::Point_2 &
PCLSegment_2<R>::min BOOST_PREVENT_MACRO_SUBSTITUTION () const
{
...
CGAL_KERNEL_INLINE
const typename PCLSegment_2<R>::Point_2 &
PCLSegment_2<R>::max BOOST_PREVENT_MACRO_SUBSTITUTION() const
{
	typename R::Less_xy_2 less_xy;
...
template < class R >
CGAL_KERNEL_INLINE
typename PCLSegment_2<R>::Direction_2
...
template < class R >
CGAL_KERNEL_INLINE
typename PCLSegment_2<R>::Vector_2
...
template < class R >
inline
typename PCLSegment_2<R>::Line_2
PCLSegment_2<R>::supporting_line() const
{
...
template < class R >
inline
typename PCLSegment_2<R>::Segment_2
PCLSegment_2<R>::opposite() const
{
...
inline
bool
PCLSegment_2<R>::is_degenerate() const
{
...
CGAL_KERNEL_INLINE
bool
PCLSegment_2<R>::is_horizontal() const
{
	return R().equal_y_2_object()(source(), target());
}
...
CGAL_KERNEL_INLINE
bool
PCLSegment_2<R>::is_vertical() const
{
...
bool
PCLSegment_2<R>::
has_on(const typename PCLSegment_2<R>::Point_2 &p) const
{
...
bool
PCLSegment_2<R>::
collinear_has_on(const typename PCLSegment_2<R>::Point_2 &p) const
{
...
template < class R >
std::istream &
operator>>(std::istream &is, PCLSegment_2<R> &s)
{
