...
void SideOfContour::my_fprint(FILE *file)
{
	...
	REGULAR_PRINT(file, "// Unknown / not calculated\n"
						...
						"EEdgeDust        = 2 -- Low confidence because of dust on stone "
						"surface\n"
						"EEdgeCavern      = 3 -- Low confidence because of cavern in the "
						"stone\n"
						"EEdgeMaxPointErr = 4 -- The edge erroneously is lower than other "
						"edges,\n"
