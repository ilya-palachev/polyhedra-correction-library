...
"${PCL_PATH}""/buildRelease/detectSectionCorners" "poly-data-in/1_GIA/shadow_contours.dat" -5 5 0.5 4 0.5 3 | tee estimate.txt
...
gnuplot -persist -e "plot 'estimate-plot.txt' using 1:2 with lines;"
