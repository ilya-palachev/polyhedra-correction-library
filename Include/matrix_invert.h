...
int mult(double* Mat0, int numStr0, int numCol0,
            double* Mat1, int numStr1, int numCol1,
            double* Res);
int sub_mult(double* Mat0, int numStr0, int numCol0,
            double* Mat1, int numStr1, int numCol1,
            double* Res);
            ...
            double* Res)
{
   ...
   if(((numStr0&numCol1)&1)!=0)
	{
   	s00=0;
      for(t=0;t<numCol0;t++) s00+=Mat0[numStr0*numCol0-numCol0+t]*Mat1[numCol1*t+numCol1-1];
