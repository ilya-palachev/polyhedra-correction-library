...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/polyhedron_join_facets_1

dist/Debug/GNU-Linux-x86/polyhedron_join_facets_1: ${OBJECTFILES}
...
${OBJECTDIR}/Polyhedron_join_facets.o: Polyhedron_join_facets.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Polyhedron_join_facets.o Polyhedron_join_facets.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/polyhedron_join_facets_1
